...
<body>
    <header class="bg-white">
        ...
        -->
                    <div
                        class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5 transition ease-in duration-150 opacity-0 translate-y-1"
                        id="productFlyout">
                        <!-- Conteúdo do menu -->
                        <div class="p-4">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const productFlyout = document.getElementById('productFlyout');
            ...
            productButton.addEventListener('click', () => {
                ...
                if (isExpanded) {
                    ...
                    productFlyout.classList.remove('opacity-100', 'translate-y-0');
                    productFlyout.classList.add('opacity-0', 'translate-y-1');
                    setTimeout(() => productFlyout.classList.add('hidden'), 150); // Match duration
                } else {
                    // Abrir o menu
                    productButton.setAttribute('aria-expanded', 'true');
                    productFlyout.classList.remove('hidden');
                    setTimeout(() => {
                        productFlyout.classList.add('opacity-100', 'translate-y-0');
                        productFlyout.classList.remove('opacity-0', 'translate-y-1');
                    }, 0);
                }
            });
            ...
            document.addEventListener('click', (event) => {
                if (!productButton.contains(event.target) && !productFlyout.contains(event.target)) {
                    productButton.setAttribute('aria-expanded', 'false');
                    productFlyout.classList.remove('opacity-100', 'translate-y-0');
                    productFlyout.classList.add('opacity-0', 'translate-y-1');
                    setTimeout(() => productFlyout.classList.add('hidden'), 150); // Match duration
